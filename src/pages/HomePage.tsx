      ...
      <main className="relative z-10">
        ...
        <section className="hero-section relative min-h-screen flex flex-col items-center justify-center overflow-hidden">
          ...
          <div className="hero-inner relative z-10 w-full max-w-7xl mx-auto px-5 py-20" style={{ marginTop: "20rem" }}>
            ...
            >
              ...
              >
                Voice–Tec Ai прослушивает и оценивает 100% звонков: кто сливает заявки, где менеджеры не дожимают клиента, какие скрипты не работают, а какие реально приносят деньги
              </motion.p>
        ...
        >
          <div className="max-w-7xl mx-auto">
            ...
            <p style={{ marginTop: "22px", textAlign: "center", fontSize: "11px", lineHeight: 1.6, color: "rgba(251,246,236,0.28)", fontFamily: "Inter, sans-serif", fontWeight: 300 }}>
