              ...
              >
                ...
                <div className="relative w-full h-full flex flex-col items-center justify-start pt-2" style={{ perspective: "1600px", zIndex: 30 }}>
                  ...
                  <motion.div
                    ...
                    style={{ width: "105%", marginLeft: "-2.5%", transformStyle: "preserve-3d", zIndex: 30 }}
                    animate={{ y: [0, -5, 0] }}
                  ...
                  >
                    ...
                    <div className="p-4">
                      ...
                      <div className="grid grid-cols-4 gap-2.5 mb-4">
                        {[
                          ...
                          <div key={m.label} className="rounded-lg p-3"
                            ...
                            <div className="text-[10px] font-medium text-gray-300 mb-1 truncate">{m.label}</div>
                            <div className="text-[13px] font-black text-white mb-0.5 truncate">{m.value}</div>
                            <div className={`text-[10px] font-bold ${m.warn ? "text-orange-300" : m.up ? "text-emerald-300" : "text-red-400"}`}>{m.change}</div>
                          </div>
                        ))}
                      </div>
                      ...
                      <div className="grid grid-cols-2 gap-2.5 mb-4">
                        <div className="rounded-lg p-3" style={{ background: "rgba(0,0,0,0.08)", border: "1px solid rgba(168,85,247,0.18)" }}>
                          <div className="flex items-center justify-between mb-2">
                            <div className="text-[11px] font-semibold text-gray-200">Динамика выручки</div>
                            <div className="text-[9px] text-violet-300 font-bold">По дням</div>
                          </div>
                          <LineChart />
                        </div>
                        <div className="rounded-lg p-3" style={{ background: "rgba(0,0,0,0.08)", border: "1px solid rgba(168,85,247,0.18)" }}>
                          <div className="text-[11px] font-semibold text-gray-200 mb-2">Причины потерь</div>
                            ...
                            <div className="space-y-1.5 flex-1">
                              {[
                                ...
                                <div key={l as string} className="flex items-center gap-1.5">
                                  ...
                                  <div className="text-[9px] text-gray-200 flex-1 truncate">{l}</div>
                                  <div className="text-[9px] font-bold text-white">{p}%</div>
                                </div>
                              ))}
                            </div>
                          </div>
                        ...
                        <div className="rounded-lg p-3" style={{ background: "rgba(0,0,0,0.08)", border: "1px solid rgba(168,85,247,0.18)" }}>
                          <div className="flex items-center mb-2">
                            ...
                            <div className="flex gap-2">
                              <div className="text-[8px] text-gray-500 w-9 text-right">Конв.</div>
                              <div className="text-[8px] text-gray-500 w-13 text-right">Выручка</div>
                          ...
                          <div className="space-y-2">
                            {[
                              ...
                              <div key={i} className="flex items-center gap-2">
                                ...
                                <div className="text-[9px] text-gray-300 w-9 text-right">{m.conv}%</div>
                                <div className="text-[9px] text-violet-300 font-semibold w-13 text-right">{m.revenue}</div>
                                <div className="text-[9px] font-bold w-8 text-right" style={{ color: m.qual >= 90 ? "#34d399" : "#fbbf24" }}>{m.qual}%</div>
                              </div>
                            ))}
                          </div>
                        </div>
                        <div className="rounded-lg p-3 flex flex-col items-center justify-center" style={{ background: "rgba(0,0,0,0.08)", border: "1px solid rgba(168,85,247,0.18)" }}>
                          ...
                          <div className="flex items-center gap-1 mt-3">
                            <Icon name="TrendingUp" size={10} className="text-emerald-400" />
                            <span className="text-[9px] text-emerald-300 font-semibold">+16%</span>
                            <span className="text-[9px] text-gray-300">к прошлому</span>
                          </div>
                        </div>
                      </div>
                    </div>
