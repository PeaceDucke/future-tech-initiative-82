...
<span style={{
      ...
      <style>{`
        ...
        @media (max-width: 767px) {
          ...
          .aiv-params-col span { font-size: 9.5px !important; white-space: nowrap !important; }
  ...
  const cases = [
    {
      ...
      textExtraShift: 6,
      logoExtraLeft: 24,
      logo: "https://cdn.poehali.dev/projects/37dcdff6-620e-46de-9c90-6860a1bec235/bucket/79220356-2763-45e3-9608-cfc680221c2a.webp",
      accent: "#D4B074",
    ...
    },
    {
      ...
      tagShift: 18,
      textExtraShift: 6,
      logo: "https://cdn.poehali.dev/projects/37dcdff6-620e-46de-9c90-6860a1bec235/bucket/ebc37faa-14bd-4113-afd2-4e63e3c98918.webp",
      accent: "#4ADE80",
    ...
    },
    {
      ...
      tagShift: 36,
      textExtraShift: 20,
      logo: "https://cdn.poehali.dev/projects/37dcdff6-620e-46de-9c90-6860a1bec235/bucket/c9963c30-1623-41fb-9d16-ca4ec5e08d69.webp",
      accent: "#7DA9FF",
    ...
    },
    {
      ...
      tagShift: -20,
      logo: "https://cdn.poehali.dev/projects/37dcdff6-620e-46de-9c90-6860a1bec235/bucket/101c484a-fc27-402a-99e0-1dd731b6c9f9.webp",
      accent: "#B98CF5",
...
function BeforeAfterSection() {
  ...
  const rows = [
    ...
    {
      before: { value: "Потерянные продажи", label: "Большинство ошибок или нарушений в разговорах остаются незамеченными" },
      after: { value: "Рост продаж", label: "AI мгновенно находит причины потери клиентов и показывает, что можно исправить" },
    },
    {
...
<span style={{
          ...
          <div className="flex flex-col gap-20 lg:gap-28">
                ...
                <div className="flex flex-col" style={{ gap: "0px" }}>
                  {[
                    ...
                    >
                      ...
                      />
                      <p className="pipeline-row-text" style={{ flex: 1, minWidth: 0, marginRight: "-24px", fontFamily: '"Bodoni Moda", Georgia, serif', fontSize: "18px", color: W, lineHeight: 1.6, fontWeight: 500 }}>
                        {item.text}
                      </p>
                    </motion.div>
                  ))}
            ...
            <div className="flex flex-col lg:flex-row-reverse items-start gap-10 lg:gap-0">
              <div className="pc pipeline-card-right w-full lg:w-[48%]" style={pCard}>
                ...
                {num("02")}
                <h3 className="pipeline-card2-title" style={{ fontFamily: '"Bodoni Moda", Georgia, serif', fontSize: "22px", color: W, fontWeight: 400, lineHeight: 1.2, marginTop: "0px", marginBottom: "32px", textAlign: "center" }}>
                ...
                <div className="pipeline-dashboard" style={{
                  ...
                  <div style={{ padding: "13px 6px 15px" }}>
                    <span className="pipeline-causes-title" style={{ display: "block", textAlign: "center", fontFamily: "Inter, sans-serif", fontSize: "21px", color: "#2E2113", fontWeight: 800, letterSpacing: "-0.01em", lineHeight: 1.12, whiteSpace: "nowrap" }}>Обнаружены причины потерь</span>
                  </div>
      ...
      <style>{`
        @media (max-width: 767px) {
          ...
          .bw-title { font-size: min(16px, 4.4vw) !important; color: #FFFFFF !important; overflow-wrap: break-word !important; word-break: keep-all !important; hyphens: manual !important; }
        ...
        <section className="hero-section relative min-h-screen flex flex-col items-center justify-center overflow-hidden" style={{ minHeight: "56.25vw", maxHeight: "820px" }}>
          ...
          <div
            ...
            style={{
              ...
              left: "61%",
              top: "68%",
              transform: "translate(calc(-50% + 400px), calc(-50% - 130px))",
              width: "155px",
              height: "155px",
              zIndex: 6,
              pointerEvents: "none",
          ...
          <div className="hero-inner absolute left-0 right-0 bottom-0 z-10 w-full max-w-7xl mx-auto px-5" style={{ paddingBottom: "13px" }}>
            ...
            >
              ...
              >
                ...
                находим ошибки менеджеров и помогаем увеличивать конверсию
              </motion.p>
                ...
                >
                  ...
                  <div className="flex items-center justify-between px-7 py-2 border-b" style={{ background: "var(--db-bg-2)", borderColor: "rgba(var(--db-text-rgb),0.18)" }}>
                    <div className="flex items-center gap-3">
                      <img src="https://cdn.poehali.dev/projects/37dcdff6-620e-46de-9c90-6860a1bec235/bucket/84683cd3-18e9-4107-8951-4bc4c593cd04.webp" alt="Voice-Tec" style={{ width: "49px", height: "44px", objectFit: "fill" }} />
