            ...
            >
              ...
              <text fill="url(#awardGold)" style={{ fontFamily: '"Bodoni Moda", Georgia, serif', fontSize: "19px", fontWeight: 600, letterSpacing: "1.6px", textTransform: "uppercase" }}>
                <textPath href="#awardCircle" startOffset="0%">
                  Оптимизировано 30<tspan style={{ fontWeight: 900, fontSize: "26px" }}>+</tspan> компаний
                </textPath>
              </text>
            </svg>
            <img
                  ...
                  <span className="hero-award-mobile" style={{ position: "absolute", right: "6px", top: "50%", transform: "translateY(-50%)", width: "96px", height: "96px", pointerEvents: "none" }}>
                    <svg viewBox="0 0 200 200" style={{ position: "absolute", inset: 0, width: "100%", height: "100%", animation: "awardSpin 18s linear infinite" }}>
                      ...
                      <text fill="url(#awardGoldM)" style={{ fontFamily: '"Bodoni Moda", Georgia, serif', fontSize: "19px", fontWeight: 600, letterSpacing: "1.6px", textTransform: "uppercase", WebkitTextStroke: "0" }}>
                        <textPath href="#awardCircleM" startOffset="0%">Оптимизировано 30<tspan style={{ fontWeight: 900, fontSize: "26px" }}>+</tspan> компаний</textPath>
                      </text>
                    </svg>
                    <img
                      src="https://cdn.poehali.dev/projects/37dcdff6-620e-46de-9c90-6860a1bec235/bucket/6bfcac18-1ac5-44d9-80db-4d7f1f5441b9.png"
