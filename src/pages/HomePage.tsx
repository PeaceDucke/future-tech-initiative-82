  ...
  return (
    ...
    >
      ...
      <main className="relative z-10">
        {/* ═══ HERO ═══ */}
        <section className="hero-section relative min-h-screen flex flex-col items-center justify-center overflow-hidden" style={{ minHeight: "56.25vw", maxHeight: "900px" }}>
          ...
          <div className="hero-inner absolute left-0 right-0 top-0 z-10 w-full max-w-7xl mx-auto px-5" style={{ paddingTop: "clamp(360px, 44vw, 500px)" }}>
            <motion.div
              initial="hidden"
              animate="visible"
              variants={stagger}
            ...
            >
              ...
              <motion.p
                variants={fadeUp}
                className="hero-lead text-[18px] mb-6"
