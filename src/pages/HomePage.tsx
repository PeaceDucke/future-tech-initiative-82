                  ...
                  {[
                    ...
                    >
                      <img
                        src={item.img}
                        alt=""
                        style={{ width: "158px", height: "158px", objectFit: "contain", flexShrink: 0, marginLeft: "-56px", filter: "drop-shadow(0 6px 16px rgba(212,176,116,0.25))" }}
                      />
                      <p style={{ fontFamily: "Inter, sans-serif", fontSize: "18px", color: W, lineHeight: 1.6, fontWeight: 500 }}>
                        {item.text}
                      </p>
                    </div>
                  ))}
